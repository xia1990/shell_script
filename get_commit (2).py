...
filename=commands.getoutput('ssh -p 29418 10.0.30.251 gerrit query branch:master after:"2019-08-17" project:^LNX_LA_SDM450_PSW/.*  status:merged  | grep "subject" > message.txt')
commit_msg=[]
...
def write_excel():
    ...
    f.save(time.strftime("%Y%m%d")+"问题修改点.xls")
