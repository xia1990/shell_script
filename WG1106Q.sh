...
ftp -n 10.30.11.100 2>&1 <<EOC
  ...
  mkdir $VARNT
  cd $VARNT
  lcd ${PATHROOT}/$PROJECTBP/SCM_COPY_FILES/msm8916_32_t1host_global_${printer}_user/multiflash_images
  put WG1106Q_${VARNT}_${NEXT_VER}_${DATE}.zip
  lcd ${PATHROOT}/$PROJECTBP/SCM_COPY_FILES/msm8916_32_t1host_global_${printer}_user
